        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="jabatan_kode" id="jabatan_kode" class="form-control" required>
                    <small id="error-jabatan_id" class="error-text form-text text-danger"></small>
                </div>
                
                <div class="form-group">
                    <label>Jabatan Nama</label>
                    <input type="text" name="jabatan_nama" id="jabatan_nama" class="form-control" required>
